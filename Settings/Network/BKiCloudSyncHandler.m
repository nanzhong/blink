...
NSString *BKiCloudContainerIdentifier = @"iCloud.io.notanumber.blinkshell";
...
//  CKDatabase *database = [[CKContainer containerWithIdentifier:@"iCloud.io.notanumber.blinkshell"]privateCloudDatabase];
